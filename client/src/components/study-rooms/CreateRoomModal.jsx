...
export function CreateRoomModal({ isOpen, onSubmit, onClose, isSubmitting }) {
        ...
        <>
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <h2 id="create-room-title" className="text-lg font-semibold text-gray-900 dark:text-gray-50">
                New study room
              </h2>
              <button
                type="button"
